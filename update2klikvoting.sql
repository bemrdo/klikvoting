...
DROP TABLE IF EXISTS `c_cDkAuup3`;
CREATE TABLE `c_cDkAuup3` (
  `id_candidate` varchar(40) NOT NULL,
  `id_voting` varchar(40) NOT NULL,
  `username` varchar(40) NOT NULL,
  `pass` varchar(40) NOT NULL,
  ...
  PRIMARY KEY (`id_candidate`),
  KEY `id_voting` (`id_voting`),
  CONSTRAINT `c_cDkAuup3_ibfk_1` FOREIGN KEY (`id_voting`) REFERENCES `voting` (`id_voting`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

DROP TABLE IF EXISTS `c_EppRx2ue`;
CREATE TABLE `c_EppRx2ue` (
  `id_candidate` varchar(40) NOT NULL,
  `id_voting` varchar(40) NOT NULL,
  `username` varchar(40) NOT NULL,
  `pass` varchar(40) NOT NULL,
  ...
  PRIMARY KEY (`id_candidate`),
  KEY `id_voting` (`id_voting`),
  CONSTRAINT `c_EppRx2ue_ibfk_1` FOREIGN KEY (`id_voting`) REFERENCES `voting` (`id_voting`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
DROP TABLE IF EXISTS `c_JxhpjH2S`;
CREATE TABLE `c_JxhpjH2S` (
  `id_candidate` varchar(40) NOT NULL,
  `id_voting` varchar(40) NOT NULL,
  `username` varchar(40) NOT NULL,
  `pass` varchar(40) NOT NULL,
  ...
  PRIMARY KEY (`id_candidate`),
  KEY `id_voting` (`id_voting`),
  CONSTRAINT `c_JxhpjH2S_ibfk_1` FOREIGN KEY (`id_voting`) REFERENCES `voting` (`id_voting`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

DROP TABLE IF EXISTS `c_tJ6GhYjo`;
CREATE TABLE `c_tJ6GhYjo` (
  `id_candidate` varchar(40) NOT NULL,
  `id_voting` varchar(40) NOT NULL,
  `username` varchar(40) NOT NULL,
  `pass` varchar(40) NOT NULL,
  ...
  PRIMARY KEY (`id_candidate`),
  KEY `id_voting` (`id_voting`),
  CONSTRAINT `c_tJ6GhYjo_ibfk_1` FOREIGN KEY (`id_voting`) REFERENCES `voting` (`id_voting`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
DROP TABLE IF EXISTS `h_cDkAuup3`;
CREATE TABLE `h_cDkAuup3` (
  `id_hash` varchar(40) NOT NULL,
  `id_voting` varchar(40) NOT NULL,
  `id_candidate` varchar(40) NOT NULL,
  `role` varchar(40) NOT NULL,
  ...
  KEY `id_voting` (`id_voting`),
  KEY `id_candidate` (`id_candidate`),
  CONSTRAINT `h_cDkAuup3_ibfk_1` FOREIGN KEY (`id_voting`) REFERENCES `voting` (`id_voting`),
  CONSTRAINT `h_cDkAuup3_ibfk_2` FOREIGN KEY (`id_candidate`) REFERENCES `c_cDkAuup3` (`id_candidate`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

DROP TABLE IF EXISTS `h_EppRx2ue`;
CREATE TABLE `h_EppRx2ue` (
  `id_hash` varchar(40) NOT NULL,
  `id_voting` varchar(40) NOT NULL,
  `id_candidate` varchar(40) NOT NULL,
  `role` varchar(40) NOT NULL,
  ...
  KEY `id_voting` (`id_voting`),
  KEY `id_candidate` (`id_candidate`),
  CONSTRAINT `h_EppRx2ue_ibfk_1` FOREIGN KEY (`id_voting`) REFERENCES `voting` (`id_voting`),
  CONSTRAINT `h_EppRx2ue_ibfk_2` FOREIGN KEY (`id_candidate`) REFERENCES `c_EppRx2ue` (`id_candidate`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
DROP TABLE IF EXISTS `h_JxhpjH2S`;
CREATE TABLE `h_JxhpjH2S` (
  `id_hash` varchar(40) NOT NULL,
  `id_voting` varchar(40) NOT NULL,
  `id_candidate` varchar(40) NOT NULL,
  `role` varchar(40) NOT NULL,
  ...
  KEY `id_voting` (`id_voting`),
  KEY `id_candidate` (`id_candidate`),
  CONSTRAINT `h_JxhpjH2S_ibfk_1` FOREIGN KEY (`id_voting`) REFERENCES `voting` (`id_voting`),
  CONSTRAINT `h_JxhpjH2S_ibfk_2` FOREIGN KEY (`id_candidate`) REFERENCES `c_JxhpjH2S` (`id_candidate`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

DROP TABLE IF EXISTS `h_tJ6GhYjo`;
CREATE TABLE `h_tJ6GhYjo` (
  `id_hash` varchar(40) NOT NULL,
  `id_voting` varchar(40) NOT NULL,
  `id_candidate` varchar(40) NOT NULL,
  `role` varchar(40) NOT NULL,
  ...
  KEY `id_voting` (`id_voting`),
  KEY `id_candidate` (`id_candidate`),
  CONSTRAINT `h_tJ6GhYjo_ibfk_1` FOREIGN KEY (`id_voting`) REFERENCES `voting` (`id_voting`),
  CONSTRAINT `h_tJ6GhYjo_ibfk_2` FOREIGN KEY (`id_candidate`) REFERENCES `c_tJ6GhYjo` (`id_candidate`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `user` (
  ...
  `reset_key_created` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id_user`),
...
DROP TABLE IF EXISTS `v_cDkAuup3`;
CREATE TABLE `v_cDkAuup3` (
  `id_voter` varchar(40) NOT NULL,
  `id_voting` varchar(40) NOT NULL,
  `username` varchar(40) NOT NULL,
  `pass` varchar(40) NOT NULL,
  ...
  PRIMARY KEY (`id_voter`),
  KEY `id_voting` (`id_voting`),
  CONSTRAINT `v_cDkAuup3_ibfk_1` FOREIGN KEY (`id_voting`) REFERENCES `voting` (`id_voting`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

DROP TABLE IF EXISTS `v_EppRx2ue`;
CREATE TABLE `v_EppRx2ue` (
  `id_voter` varchar(40) NOT NULL,
  `id_voting` varchar(40) NOT NULL,
  `username` varchar(40) NOT NULL,
  `pass` varchar(40) NOT NULL,
  ...
  PRIMARY KEY (`id_voter`),
  KEY `id_voting` (`id_voting`),
  CONSTRAINT `v_EppRx2ue_ibfk_1` FOREIGN KEY (`id_voting`) REFERENCES `voting` (`id_voting`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
DROP TABLE IF EXISTS `v_JxhpjH2S`;
CREATE TABLE `v_JxhpjH2S` (
  `id_voter` varchar(40) NOT NULL,
  `id_voting` varchar(40) NOT NULL,
  `username` varchar(40) NOT NULL,
  `pass` varchar(40) NOT NULL,
  ...
  PRIMARY KEY (`id_voter`),
  KEY `id_voting` (`id_voting`),
  CONSTRAINT `v_JxhpjH2S_ibfk_1` FOREIGN KEY (`id_voting`) REFERENCES `voting` (`id_voting`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

DROP TABLE IF EXISTS `v_tJ6GhYjo`;
CREATE TABLE `v_tJ6GhYjo` (
  `id_voter` varchar(40) NOT NULL,
  `id_voting` varchar(40) NOT NULL,
  `username` varchar(40) NOT NULL,
  `pass` varchar(40) NOT NULL,
  ...
  PRIMARY KEY (`id_voter`),
  KEY `id_voting` (`id_voting`),
  CONSTRAINT `v_tJ6GhYjo_ibfk_1` FOREIGN KEY (`id_voting`) REFERENCES `voting` (`id_voting`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `c_EppRx2ue` (`id_candidate`, `id_voting`, `username`, `pass`, `name`, `description`, `avatar`, `status`, `validator`, `created_at`) VALUES
('8niA4RA0', 'EppRx2ue', 'C-msPOjCUl', '2y7DjqdyOfBp', 'asd', '<p>ads</p>', '8niA4RA0_2022-01-23_144151.947401', NULL, NULL, '2022-01-23 14:41:52');
...
INSERT INTO `h_EppRx2ue` (`id_hash`, `id_voting`, `id_candidate`, `role`, `encrypted`, `status`, `created_at`) VALUES
('irG9hqJX', 'EppRx2ue', '8niA4RA0', 'voter', '1vy9xzsHgPZ82Oad0XtfWijjATYLa92YcRg2SLmVZ1A=', 'checked', '2022-01-23 15:11:07');
INSERT INTO `h_EppRx2ue` (`id_hash`, `id_voting`, `id_candidate`, `role`, `encrypted`, `status`, `created_at`) VALUES
('pNA9uWMA', 'EppRx2ue', '8niA4RA0', 'voter', '4/zdcgja75PumrCW0zWWWUlyGVWaNEeD6utdMeBztKQ=', 'checked', '2022-01-23 15:13:01');
...
('qjj4sNEk', 'EwMdQmrR', 'G9mGwLDK', 'candidate', 'Qg8HT3K32o/dWnuH9Q8bH+ERILI6ZcVxn+edz2/lNZk=', 'voted', '2022-02-11 00:30:08');
...
INSERT INTO `user` (`id_user`, `name`, `email`, `number`, `pass`, `institution`, `address`, `card_id`, `role`, `created_at`, `status`, `message`, `reset_key`, `reset_key_created`) VALUES
('8lZk8BRC', 'Panitia Pemilu BEM', 'panitiabem@mail.com', '08123456789', 'pbkdf2:sha256:260000$UBkjVleszpGIWkWX$f4b98607eba2e3ab931bb2e1fcbd7b2711c9cb9dd2de89d8975220741dad3632', 'ITB STIKOM Bali', 'Jl. Raya Puputan No.86, Dangin Puri Klod, Kec. Denpasar Tim., Kota Denpasar, Bali 80234', '8lZk8BRC_2021-08-08_170807.925488', 'organizer', '2021-08-08 17:08:08', 'approved', '[Perubahan Profil]', NULL, NULL);
INSERT INTO `user` (`id_user`, `name`, `email`, `number`, `pass`, `institution`, `address`, `card_id`, `role`, `created_at`, `status`, `message`, `reset_key`, `reset_key_created`) VALUES
('9IP9swEO', 'Admin', 'admin@mail.com', '08123456789', 'pbkdf2:sha256:260000$2k3ag2qMfshNyeOo$b221cf77e7e03aa937b1d2107da82252ada0342ae3f1570e379045b14cb8b80c', 'klikvoting', 'di rumah', '9IP9swEO_2021-07-18_225103.227726', 'admin', '2021-07-18 22:51:03', 'approved', '[Akun Admin]', NULL, NULL);
INSERT INTO `user` (`id_user`, `name`, `email`, `number`, `pass`, `institution`, `address`, `card_id`, `role`, `created_at`, `status`, `message`, `reset_key`, `reset_key_created`) VALUES
...
INSERT INTO `user` (`id_user`, `name`, `email`, `number`, `pass`, `institution`, `address`, `card_id`, `role`, `created_at`, `status`, `message`, `reset_key`, `reset_key_created`) VALUES
('PbKcAx51', 'Akun Baru', 'baru@mail.com', '087762804369', 'pbkdf2:sha256:260000$sbi2d6QcZJU4N7Qb$0b4b8a758e63a9c125ce7898232e99b70e2bad42ee2d9eeeaecf5ae7194c2b00', 'Baru', 'Alamat Baru', 'PbKcAx51_2022-01-18_124251.273833', 'organizer', '2022-01-18 12:42:51', 'pending', '[Akun Baru]', NULL, NULL),
('qxuDEyHI', 'bemrdo', 'bemr.do@gmail.com', '087762804369', 'pbkdf2:sha256:260000$9LgUFwZmaAcySsWi$d99dd0177adf6ec2c2122ab1fc94fde5eec8d83a138f71bec30f00f924209acc', 'okay', 'Jl. Katrangan Gg. leli No. 5, Ds. Sumerta, Kec. Denpasar Timur', 'qxuDEyHI_2022-02-14_000238.906692', 'organizer', '2022-02-14 00:02:39', 'pending', '[Akun Baru]', '0GsrWIHHvFA9JR1U', '2022-02-18 16:08:57');
...
INSERT INTO `v_EppRx2ue` (`id_voter`, `id_voting`, `username`, `pass`, `name`, `description`, `avatar`, `status`, `validator`, `created_at`) VALUES
('45vUlX8G', 'EppRx2ue', 'V-9brxO53R', '6oe3XlTqjRU9', 'sdf', 'sdfsd', NULL, 'irG9hqJX', '9Wz6rehSHHsMzVa3jGrEsw==', '2022-01-23 14:42:04');
INSERT INTO `v_EppRx2ue` (`id_voter`, `id_voting`, `username`, `pass`, `name`, `description`, `avatar`, `status`, `validator`, `created_at`) VALUES
('DWx8WocR', 'EppRx2ue', 'V-kQZOoTvk', '1fkcouhUTTyn', 'ads', 'ds', NULL, 'pNA9uWMA', 'sCECGiSBHj0hklNGMLYLWg==', '2022-01-23 15:12:30');
...
INSERT INTO `v_JxhpjH2S` (`id_voter`, `id_voting`, `username`, `pass`, `name`, `description`, `avatar`, `status`, `validator`, `created_at`) VALUES
('zxSqNf25', 'JxhpjH2S', 'V-s3pcrlkx', 'H5oxurygIP4p', 'voter 1', 'ok', NULL, NULL, NULL, '2022-01-23 13:32:54');
...
INSERT INTO `voting` (`id_voting`, `id_user`, `name`, `voting_desc`, `date_start`, `date_end`, `candidate`, `voter`, `viewer`, `created_at`, `last_checked`) VALUES
('cDkAuup3', '8lZk8BRC', 'asda', 'asda', '2022-01-23 15:00:00', '2022-01-25 15:00:00', '[\'cname\', \'cdesc\', \'cavatar\']', '[\'vname\', \'vdesc\']', 'off', '2022-01-23 14:40:22', '2022-01-23 14:40:22');
INSERT INTO `voting` (`id_voting`, `id_user`, `name`, `voting_desc`, `date_start`, `date_end`, `candidate`, `voter`, `viewer`, `created_at`, `last_checked`) VALUES
('EppRx2ue', '8lZk8BRC', 'ok', 'ok', '2022-01-23 14:00:00', '2022-01-24 14:00:00', '[\'cname\', \'cdesc\', \'cavatar\']', '[\'vname\', \'vdesc\']', 'off', '2022-01-23 13:33:38', '2022-01-23 15:22:24');
INSERT INTO `voting` (`id_voting`, `id_user`, `name`, `voting_desc`, `date_start`, `date_end`, `candidate`, `voter`, `viewer`, `created_at`, `last_checked`) VALUES
('EwMdQmrR', '8lZk8BRC', 'Pemilu Badan Eksekutif Mahasiswa', 'Pemilihan Ketua dan Wakil Ketua Badan Eksekutif Mahasiswa ITB STIKOM Bali Periode 2020/2021', '2021-12-29 17:00:00', '2022-02-11 01:00:00', '[\'cname\', \'cdesc\', \'cavatar\']', '[\'vname\', \'vdesc\']', 'on', '2021-08-08 17:48:49', '2022-02-11 00:10:21'),
('JxhpjH2S', '8lZk8BRC', 'sdf', 'asdfasdf', '2022-01-23 22:00:00', '2022-01-24 22:00:00', '[\'cname\', \'cdesc\', \'cavatar\']', '[\'vname\', \'vdesc\']', 'on', '2022-01-23 13:10:58', '2022-01-23 13:16:47'),
('tJ6GhYjo', '8lZk8BRC', 'nert', 'etrert', '2022-01-23 15:00:00', '2022-01-25 23:00:00', '[\'cname\', \'cdesc\', \'cavatar\']', '[\'vname\', \'vdesc\']', 'off', '2022-01-23 14:38:50', '2022-01-23 14:38:50');
